...
?>
<div class="widget">
    <p>Movemos el aporte de <strong><?php echo $user->name ?></strong> al booka <strong><?php echo $project->name; ?></strong> de <strong><?php echo $original->amount; ?> &euro;</strong> mediante <strong><?php echo $original->method; ?></strong> del d&iacute;a <strong><?php echo date('d-m-Y', strtotime($original->invested)); ?></strong>.</p>
    <form id="filter-form" action="/admin/invests/move/<?php echo $original->id ?>" method="post">
        <p>
            <label for="invest-project">Al booka:</label><br />
            <select id="invest-project" name="project">
                <option value="">Seleccionar el booka al que se mueve el aporte</option>
