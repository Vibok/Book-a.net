...
<div class="widget board">
    <form action="/admin/tags/edit" method="post" >
        ...
        <input type="hidden" name="order" value="<?php echo $tag->order; ?>" />
        ...
        <?php foreach (Lang::$langs as $langId=>$langName) : 
            ...
            <p>
                ...
                <input type="text" name="name_<?php echo $langId ?>" id="name_<?php echo $langId ?>" value="<?php echo $tag->$campo_nombre; ?>" />
            </p>
            </div>
        <?php endforeach; ?>
