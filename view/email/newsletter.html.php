...
<div style="width: 100%; background-color:#CDE4E5; padding-top:7px; padding-bottom:7px;"><span style="margin-left:50px;"><img src="cid:logo" alt=""/></span></div>
...
<div style="font-size:12px; color:#20B3B2; padding-top:10px; padding-bottom:10px;"><a href="<?php echo SITE_URL ?>" style="color:#20B3B2; text-decoration:none;"></a></div>
<div style="color:#E32526; font-size:14px; padding-top:5px; text-transform: uppercase;"><a href="<?php echo SITE_URL . '/search' ?>" style="color:#E32526; text-decoration:none;"><?php echo Text::get('regular-search'); ?></a></div>
...
<div style="font-size:11px; padding-bottom:10px;"><?php echo Text::get('booka-social-header'); ?><br />
  <span><a href="<?php echo Text::get('social-account-facebook') ?>" style="color:#233E99; text-decoration:none;">facebook</a></span> | <span><a href="<?php echo Text::get('social-account-twitter') ?>" style="color:#00AEEF; text-decoration:none;">twitter</a></span></div>
