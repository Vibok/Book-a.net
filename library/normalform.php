...
namespace Base\Library {
    ...
    class NormalForm implements \Base\Core\Resource, \Base\Core\Resource\MIME {
            ...
            if (is_array($children)) {
                ...
                foreach ($children as $k => $element) {
                    ...
                    if (!($element instanceof NormalForm\Element)) {
                        ...
                        if (!is_array($element)) {
                            throw new NormalForm\Exception;
                        }
        ...
        public function __toString () {
            ...
            return (string) (new View('library/normalform/view/form.html.php', $this));
